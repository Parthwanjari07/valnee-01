					...
					<div className="flex gap-2 sm:gap-3 mb-4 sm:mb-6 flex-wrap items-center justify-center max-w-full">
						...
						<div className="relative inline-flex items-center gap-2 sm:gap-2 rounded-full border border-white bg-white shadow-lg px-2 py-0.5 sm:px-3 sm:py-1 overflow-hidden">
							...
							<div className="relative z-10 flex -space-x-1.5 sm:-space-x-2">
								<Image
									src="https://framerusercontent.com/images/dRU460eX51GyZswEa8XXGmbpWII.png"
									alt="Founder avatar"
									width={20}
									height={20}
									className="h-3.5 w-3.5 sm:h-5 sm:w-5 rounded-full ring-1 sm:ring-2 ring-white object-cover"
								/>
								<Image
									src="https://framerusercontent.com/images/mvtXROTJXMdy5P4OQiYu7M2M234.png"
									alt="Founder avatar"
									width={20}
									height={20}
									className="h-3.5 w-3.5 sm:h-5 sm:w-5 rounded-full ring-1 sm:ring-2 ring-white object-cover"
								/>
								<Image
									src="https://framerusercontent.com/images/mDJYqZ2MM6QWu3XXMAIC4lRzFtw.png"
									alt="Founder avatar"
									width={20}
									height={20}
									className="h-3.5 w-3.5 sm:h-5 sm:w-5 rounded-full ring-1 sm:ring-2 ring-white object-cover"
							...
							<span className="relative z-10 inline-flex items-center rounded-full bg-white px-1.5 sm:px-2.5 py-[1px] sm:py-[2px] shadow ring-1 ring-black/10">
								...
								<span className="text-[10px] sm:text-[12px] italic text-[#031E2E]">
									FAST
								</span>
							</span>
						</div>
              ...
              >
                ...
                />
					...
					<p
						...
						style={{ color: "#D1D5DB" }}>
						We translate your vision into a scalable, launch-ready MVP, so
						you can focus on building your{" "}
						<span className="font-semibold" style={{ color: "#FFFFFF" }}>
							business.
						</span>
					</p>
					<div className="relative z-20 mt-8 sm:mt-10 md:mt-12 flex flex-col sm:flex-row items-center justify-evenly sm:justify-center gap-5 sm:gap-4 w-full max-w-md sm:max-w-none px-4">
						{/* Black primary button */}
						{/* CTA Button */}
						<button
							onClick={() => (window.location.href = "/contact")}
							className="flex sm:flex-row  justify-center items-center gap-3 bg-white rounded-xl flex-none px-4 py-2.5 md:px-4 md:py-2.5 w-[210px] sm:w-auto sm:min-w-[218px] h-auto md:h-[56px] hover:bg-gray-100 hover:scale-105 hover:shadow-lg hover:shadow-blue-500/20 transition-all duration-300 ease-out cursor-pointer group">
						...
						<MovingBorderButton
							...
							duration={3000}
							containerClassName="sm:w-[218px] w-[210px] h-[56px] sm:h-[56px] hover:scale-110 transition-transform duration-300"
							className="bg-black  border-white text-white font-medium"
							borderClassName="bg-[radial-gradient(white_40%,transparent_60%)]"
							aria-label="Download Brochure">
							<div className="flex gap-1 items-center justify-center shrink-0 w-fit h-full px-5 sm:px-6">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									viewBox="0 0 24 24"
									fill="none"
