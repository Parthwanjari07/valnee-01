        ...
        <div className="relative z-30 flex flex-col items-center justify-center flex-1 w-full text-center px-4 sm:px-6 md:px-8 py-20 sm:py-24 md:py-28 lg:py-36">
          ...
          <div className="mt-6 sm:mt-8 md:mt-10 flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 w-full max-w-md sm:max-w-none px-4">
            <GradientCTAButton
              ...
              size="sm"
            />
            <button className="relative inline-flex h-12 w-full sm:w-auto overflow-hidden rounded-xl p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
              <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
              <span className="px-8 sm:px-12 inline-flex h-full w-full cursor-pointer items-center justify-center rounded-xl bg-slate-950 py-1 text-sm font-medium text-white backdrop-blur-3xl">
                Book a Call
              </span>
            </button>
          </div>
