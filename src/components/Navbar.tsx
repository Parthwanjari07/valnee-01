			...
			<div className="max-w-7xl mx-auto lg:mt-6">
				<div className="flex justify-between px-4 sm:px-6 lg:px-8 items-center h-14 md:h-16 lg:rounded-[18px] lg:border lg:border-white/10 lg:bg-black/10 lg:backdrop-blur-md">
					...
					<Link
						...
						<span
							...
							style={{
								...
								background:
									"radial-gradient(251.03% 141.25% at 107.41% 17.5%, #102B65 0%, #005AB8 42.76%, #001028 100%), radial-gradient(169.49% 111.16% at 87% -12.77%, #001028 0%, #005AB8 57.24%, #102B65 100%)",
					...
					<div className="hidden lg:flex items-center gap-2 xl:gap-4 relative h-full">
						<Link
							href="/"
							className="flex items-center h-full px-3 xl:px-4 text-white font-medium text-sm xl:text-base hover:text-cyan-400 transition-colors">
							Home
						</Link>
						<Link
							href="#cardEffects"
