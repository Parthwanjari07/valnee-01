        ...
        <div className="flex flex-col gap-16">
          ...
          >
            ...
            <div className="flex flex-col w-full md:w-1/2 space-y-8">
              ...
              <p className="text-base md:text-xl  font-[lobster] text-[#79FFFF]">
                We own the complexity, you own the vision.
              </p>
              <p className="text-gray-300 md:text-lg font-[lora] leading-relaxed">
                Our first job is to convert your high-level business goals and
                product logic into a crystal-clear, risk-mitigated technical
                blueprint. This eliminates the confusion that plagues
          ...
          >
            ...
            <div className="flex flex-col w-full md:w-1/2 space-y-8">
              ...
              <p className="text-base md:text-xl ">
                ...
                <span className="font-[lobster]"> Trello workspace </span>with
          ...
          >
            ...
            <div className="flex flex-col w-full md:w-1/2 space-y-8">
              ...
              <p className="text-base md:text-xl  font-[lobster] text-[#79FFFF]">
                At Valnee, I’ve (Parth Wanjari) personally handpicked every team
                member for their skills, values, and drive.{" "}
              </p>
              <p className="text-gray-300 md:text-lg font-[lora] leading-relaxed">
                Focus over features. Our process is optimized for speed,
                prioritizing the minimum viable functionality needed to validate
                your idea and attract investment.
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            <div className="flex flex-col w-full md:w-1/2 space-y-8">
              ...
              <p className="text-gray-300 md:text-lg font-[lora] leading-relaxed">
                While we build fast, we never cut corners on quality. We deliver
                clean, well-documented code that is an asset, ready to handle
                growth and be easily taken over by a future technical co-founder
                or in-house team
              </p>
            </div>
          </div>
